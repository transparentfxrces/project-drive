...
function App() {
  ...
  /*
   * Keep the account ID explicit so
   * account-specific data can be loaded
   * and saved safely.
   */
  const userId =
    user?.id ?? null;
  ...
  /*
   * Account-specific recruiting data.
   *
   * Basic athlete identity comes from
   * the player profile. This object is
   * reserved for recruiting-specific
   * information.
   */
  const [recruitProfile, setRecruitProfile] =
    useState({
      graduationYear: "",
      height: "",
      weight: "",
